...
export default {
    name: 'checkadmin',
    aliases: ['isadmin', 'admincheck'],
    description: 'Vérifie si un utilisateur est administrateur du groupe',
    category: 'Group',
    async execute(ctx: CommandContext) {
        ...
        try {
            ...
            await ctx.sock.sendMessage(ctx.remoteJid, { text: '❌ Erreur de vérification.' });
        }
    }
};
